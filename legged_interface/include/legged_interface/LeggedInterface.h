...
class LeggedInterface : public RobotInterface {
 ...
 protected:
  ...
  std::unique_ptr<StateInputCost> getTailPositionSoftConstraint(const EndEffectorKinematics<scalar_t>& eeKinematics,size_t contactPointIndex,
                                                                               const RelaxedBarrierPenalty::Config& barrierPenaltyConfig);
  std::unique_ptr<StateInputCost> getArmPositionSoftConstraint(const EndEffectorKinematics<scalar_t>& eeKinematics,size_t contactPointIndex,
                                                                               const SmoothAbsolutePenalty::Config& QuadraticPenaltyConfig);
  std::unique_ptr<StateInputCost> getFootPositionSoftConstraint(const EndEffectorKinematics<scalar_t>& eeKinematics,size_t contactPointIndex,
                                                                               const RelaxedBarrierPenalty::Config& barrierPenaltyConfig);
